# -*- coding: utf-8 -*-
"""
Created on Sun Mar 25 14:14:24 2018
...
start = time.time()
df3 = pd.read_csv('C:/Users/Mausamee Patel/Desktop/Project/A5/Ratings_1Million3.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
...
start = time.time()
df4 = pd.read_csv('C:/Users/Mausamee Patel/Desktop/Project/A5/Ratings_1Million4.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
